...
| Param          | Example                                                                                           | Notes                                                                                                                                                                                                                                                                                                                          |
| -------------- | ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `startRow`     | `0`                                                                                               | default `0`                                                                                                                                                                                                                                                                                                                    |
| `endRow`       | `25`                                                                                              | default `startRow + 25`, capped at 500 rows/page; must not be less than `startRow`. If equal to `startRow`, treated leniently as a 1-row page (`endRow` bumped to `startRow + 1`)                                                                                                                                              |
| `quickSearch`  | `chicago`                                                                                         | matches every field (`id`, `companyName`, `origin`, `destination`, `weight`, `equipmentType`, `date`, `price`, `distance`, `status`), mirroring the client's AG Grid quick filter                                                                                                                                              |
| `sortModel`    | `[{"colId":"price","sort":"desc"}]`                                                               | single-column sort; JSON-encoded, URL-escaped                                                                                                                                                                                                                                                                                  |
